...
def supervised_training_iter(
    ...
    """ Supervised training iteration of assn
    This function trains assn for one iteration in a labeled dataset.
    ...
    Example:
        ...
        optimizer = torch.optim.SGD(assn.parameters(), lr=lr, momentum=0.9)
        ...
        for epoch in range(0, epochs):
            for idx, (image, trimap, gt_matte) in enumerate(dataloader):
                semantic_loss, detail_loss, matte_loss = \
                    supervised_training_iter(assn, optimizer, image, trimap, gt_matte)
            lr_scheduler.step()
    """
